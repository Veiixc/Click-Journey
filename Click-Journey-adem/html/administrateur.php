...
require_once '../php/includes/functions.php'; // Ajout de cette ligne pour inclure readCSV()
requireAdmin(); // Utilise la fonction requireAdmin au lieu de requireLogin
